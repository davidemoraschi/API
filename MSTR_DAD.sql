/* Formatted on 02/01/2013 12:57:59 (QP5 v5.163.1008.3004) */
BEGIN
   DBMS_EPG.drop_dad (dad_name => 'mstr');
END;
/

BEGIN
   DBMS_EPG.create_dad (dad_name => 'mstr', PATH => '/mstr/*');
   DBMS_EPG.authorize_dad (dad_name => 'mstr', USER => 'MSTR');
   DBMS_EPG.set_dad_attribute (dad_name => 'mstr', attr_name => 'default-page', attr_value => 'home.htm');
   DBMS_EPG.set_dad_attribute (dad_name => 'mstr', attr_name => 'database-username', attr_value => 'MSTR');
   DBMS_EPG.set_dad_attribute (dad_name => 'mstr', attr_name => 'nls-language', attr_value => 'american_america.al32utf8');
   DBMS_EPG.authorize_dad (dad_name => 'mstr', USER => 'MSTR');
END;
/

BEGIN
   DBMS_EPG.SET_DAD_ATTRIBUTE (dad_name => 'mstr', attr_name => 'cgi-environment-list', attr_value => 'HTTP_IF_NONE_MATCH');

   DBMS_EPG.SET_DAD_ATTRIBUTE (dad_name => 'mstr', attr_name => 'cgi-environment-list', attr_value => 'IF_MODIFIED_SINCE');
END;
/
