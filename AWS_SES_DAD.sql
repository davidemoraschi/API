...
BEGIN
   DBMS_EPG.drop_dad (dad_name => 'aws_ses');
END;
/

BEGIN
   DBMS_EPG.create_dad (dad_name => 'aws_ses', PATH => '/aws_ses/*');
   DBMS_EPG.authorize_dad (dad_name => 'aws_ses', USER => 'AWS_SES');
   DBMS_EPG.set_dad_attribute (dad_name => 'aws_ses', attr_name => 'default-page', attr_value => 'home.htm');
   DBMS_EPG.set_dad_attribute (dad_name => 'aws_ses', attr_name => 'database-username', attr_value => 'AWS_SES');
   DBMS_EPG.set_dad_attribute (dad_name => 'aws_ses', attr_name => 'nls-language', attr_value => 'american_america.al32utf8');
   DBMS_EPG.authorize_dad (dad_name => 'aws_ses', USER => 'AWS_SES');
END;
/
