...
BEGIN
   ...
   DBMS_NETWORK_ACL_ADMIN.assign_acl (acl => 'pandas.xml', HOST => 'pandas');
...
EXEC DBMS_NETWORK_ACL_ADMIN.ASSIGN_WALLET_ACL ('mstr.xml', 'file:C:\oracle');
--EXEC DBMS_NETWORK_ACL_ADMIN.UNASSIGN_WALLET_ACL ('mstr_client_cert.xml', 'file:/u01/app/oracle/wallet');