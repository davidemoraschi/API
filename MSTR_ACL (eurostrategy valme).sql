...
BEGIN
   ...
   DBMS_NETWORK_ACL_ADMIN.add_privilege (acl          => 'mstr_eurostrategy.xml',
                                         ...
                                         start_date   => NULL,
                                         end_date     => NULL);
   DBMS_NETWORK_ACL_ADMIN.assign_acl (acl => 'mstr_eurostrategy.xml', HOST => '10.232.32.179');
   DBMS_NETWORK_ACL_ADMIN.assign_acl (acl => 'mstr_eurostrategy.xml', HOST => 'proxy02.sas.junta-andalucia.es');
